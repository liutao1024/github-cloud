...
public class SysTransactionInformation implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SysTransactionInformation other = (SysTransactionInformation) obj;
		if (errorMesage == null) {
	...
	public String toString() {
		return "SysTransactionInformation [serialNumber=" + serialNumber
