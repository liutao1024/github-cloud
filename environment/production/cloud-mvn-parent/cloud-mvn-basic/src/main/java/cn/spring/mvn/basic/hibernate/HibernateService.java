...
//	public abstract List<T> findByFilter(BasicUtilHqlFilter paramHqlFilter);
//	@Deprecated
//	public abstract List<T> findByFilter(BasicUtilHqlFilter paramHqlFilter, int paramInt1, int paramInt2);

	public abstract long countByFilter();
//	public abstract long countByFilter(BasicUtilHqlFilter paramHqlFilter);
