...
//	@Autowired
//	private ApSysDictRepository apSysDictRepositoryImpl;
//	@Autowired
...
//	public List<ApSysDict> toGetDictsByDictType(@RequestBody ApSysDict sysDict){
//		List<ApSysDict> sysDictList = apSysDictRepositoryImpl.findByDictType(sysDict.getDictType());
//		return sysDictList;
//	}
//	/**
