package cn.spring.mvn.client.web.model;
...
import cn.spring.mvn.client.web.model.primarykey.SifSysDictPK;


/**
 * @author LiuTao @date 2018年10月11日 上午10:05:27
 * @ClassName: SifSysDict 
 * @Description: tableName : sif_sys_dict
 */
@Entity
@IdClass(SifSysDictPK.class)
@Table(name = "sif_sys_dict")
public class SifSysDict implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SifSysDict other = (SifSysDict) obj;
		if (dictId == null) {
	...
	public String toString() {
		return "ApSysDict [dictType=" + dictType + ", dictId=" + dictId
