...
import cn.spring.mvn.client.web.model.service.SifSysRoleService;
import cn.spring.mvn.client.web.model.service.SifSysRoleUserService;
import cn.spring.mvn.client.web.model.service.SifSysUserService;
...
//		List<SifSysRoleUser> roleUsers = sifSysRoleUserService.queryEntitiesByTemplateWithSort(tmp, new Sort(orderList));
		Sort sort = new Sort(Direction.ASC, "userCd");
		List<SifSysRoleUser> roleUsers = sifSysRoleUserService.queryEntitiesByTemplateWithSort(tmp, sort);
