						...
						<form class="form-horizontal" role="form" id="edit_form" action=""
							...
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" id="maxert" name="maxert"
											class="form-control input-inline input-medium" maxlength="2"
											placeholder="密码错误最大次数">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
											...
											class="form-control input-inline input-medium" placeholder="柜员等级" maxlength="36"></input>
									</div>
								</div> 
							</div>
...
<script src="${ctx}/pages/jsp/system/user.js"></script>
<script>
