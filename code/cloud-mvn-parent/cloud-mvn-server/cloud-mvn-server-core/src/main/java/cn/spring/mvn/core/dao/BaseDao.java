package cn.spring.mvn.core.dao;

import java.io.Serializable;
import java.util.List;
import java.util.Map;

import cn.spring.mvn.core.PageEntity;
import cn.spring.mvn.core.PageResult;
...
public interface BaseDao<T,PK extends Serializable> {
     ...
     */  
    public abstract int updateParam(Map<String, Object> param);  
     ...
     * @return 
     */  
    public abstract int deleteParam(Map<String, Object> param);  
     ...
     */  
    public abstract List<T> selectParam(Map<String, Object> param);  
     ...
     */  
    public abstract PageResult<T> selectPagination(PageEntity param);  
